...
int ffkmp_averror_eagain(void);
int ffkmp_averror_eof(void);
int ffkmp_averror_einval(void);
int64_t ffkmp_nopts_value(void);
 ...
 */
AVFrame* ffkmp_frame_alloc(void);
 ...
 */
void     ffkmp_frame_free(AVFrame *f);
 ...
 */
void     ffkmp_frame_unref(AVFrame *f);
 ...
 */
int      ffkmp_frame_ref(AVFrame *dst, AVFrame *src);
int64_t  ffkmp_frame_pts(AVFrame *f);
int64_t  ffkmp_frame_duration(AVFrame *f);
int      ffkmp_frame_format(AVFrame *f);
int      ffkmp_frame_width(AVFrame *f);
int      ffkmp_frame_height(AVFrame *f);
int      ffkmp_frame_nb_samples(AVFrame *f);
int      ffkmp_frame_sample_rate(AVFrame *f);
int      ffkmp_frame_channels(AVFrame *f);
int      ffkmp_frame_linesize(AVFrame *f, int p);
void     ffkmp_frame_set_pts(AVFrame *f, int64_t pts);
void     ffkmp_frame_set_format(AVFrame *f, int v);
void     ffkmp_frame_set_width(AVFrame *f, int v);
void     ffkmp_frame_set_height(AVFrame *f, int v);
void     ffkmp_frame_set_sample_rate(AVFrame *f, int v);
void     ffkmp_frame_set_nb_samples(AVFrame *f, int v);
 ...
 */
int      ffkmp_frame_get_buffer(AVFrame *f, int align);
 ...
 */
int      ffkmp_frame_make_writable(AVFrame *f);
 ...
 */
AVFrame* ffkmp_frame_clone(const AVFrame *f);
...
const char* ffkmp_pix_fmt_name(int fmt);
int         ffkmp_pix_fmt_from_name(const char *n);
const char* ffkmp_sample_fmt_name(int fmt);
int         ffkmp_sample_fmt_from_name(const char *n);

/* AVDictionary iteration */
AVDictionaryEntry* ffkmp_dict_get(AVDictionary *d, AVDictionaryEntry *prev);
const char* ffkmp_dict_entry_key(AVDictionaryEntry *e);
const char* ffkmp_dict_entry_value(AVDictionaryEntry *e);
 ...
 */
AVPacket* ffkmp_packet_alloc(void);
 ...
 */
void      ffkmp_packet_free(AVPacket *p);
 ...
 */
void      ffkmp_packet_unref(AVPacket *p);
 ...
 */
int       ffkmp_packet_ref(AVPacket *d, AVPacket *s);
int64_t   ffkmp_packet_pts(AVPacket *p);
int64_t   ffkmp_packet_dts(AVPacket *p);
int       ffkmp_packet_stream_index(AVPacket *p);
int       ffkmp_packet_flags(AVPacket *p);
int       ffkmp_packet_size(AVPacket *p);
uint8_t*  ffkmp_packet_data(AVPacket *p);
int64_t   ffkmp_packet_duration(AVPacket *p);
int       ffkmp_packet_is_keyframe(AVPacket *p);
void      ffkmp_packet_set_stream_index(AVPacket *p, int i);
void      ffkmp_packet_set_pts(AVPacket *p, int64_t v);
void      ffkmp_packet_set_dts(AVPacket *p, int64_t v);
void      ffkmp_packet_rescale_ts(AVPacket *p, int sn, int sd, int dn, int dd);

/* AVCodecParameters */
int     ffkmp_codecpar_codec_type(AVCodecParameters *p);
int     ffkmp_codecpar_codec_id(AVCodecParameters *p);
int64_t ffkmp_codecpar_bit_rate(AVCodecParameters *p);
int     ffkmp_codecpar_width(AVCodecParameters *p);
int     ffkmp_codecpar_height(AVCodecParameters *p);
int     ffkmp_codecpar_format(AVCodecParameters *p);
int     ffkmp_codecpar_sample_rate(AVCodecParameters *p);
int     ffkmp_codecpar_channels(AVCodecParameters *p);
int     ffkmp_codecpar_video_delay(AVCodecParameters *p);
 ...
 */
AVCodecContext* ffkmp_codecctx_alloc(const AVCodec *c);
 ...
 */
void  ffkmp_codecctx_free(AVCodecContext *c);
 ...
 */
int   ffkmp_codecctx_open(AVCodecContext *c, const AVCodec *codec);
 ...
 */
int   ffkmp_codecctx_from_par(AVCodecContext *c, AVCodecParameters *p);
...
int   ffkmp_codecctx_frame_size(AVCodecContext *c);
int   ffkmp_codecctx_sample_rate(AVCodecContext *c);
int   ffkmp_codecctx_sample_fmt(AVCodecContext *c);
int   ffkmp_codecctx_channels(AVCodecContext *c);
...
const char* ffkmp_codec_name(const AVCodec *c);
const AVCodec* ffkmp_find_decoder_by_id(int id);
const char* ffkmp_codec_id_name(int id);
int ffkmp_codecctx_pix_fmt(AVCodecContext *c);
int ffkmp_codecctx_width(AVCodecContext *c);
int ffkmp_codecctx_height(AVCodecContext *c);
 ...
 * the caller's.
 */
int  ffkmp_fmt_find_stream_info(AVFormatContext *c);
 ...
 */
int  ffkmp_fmt_read_frame(AVFormatContext *c, AVPacket *p);
int64_t       ffkmp_fmt_duration(AVFormatContext *c);
int64_t       ffkmp_fmt_start_time(AVFormatContext *c);
int64_t       ffkmp_fmt_bit_rate(AVFormatContext *c);
unsigned      ffkmp_fmt_nb_streams(AVFormatContext *c);
AVStream*     ffkmp_fmt_stream(AVFormatContext *c, unsigned i);
const char*   ffkmp_fmt_iformat_name(AVFormatContext *c);
AVDictionary* ffkmp_fmt_metadata(AVFormatContext *c);
 ...
 */
int ffkmp_fmt_write_header(AVFormatContext *ctx);
 ...
 * interleaving queue.
 */
int ffkmp_fmt_write_frame(AVFormatContext *ctx, AVPacket *p);
 ...
 */
int ffkmp_fmt_write_trailer(AVFormatContext *ctx);
...
/* AVStream */
int                  ffkmp_stream_index(AVStream *s);
AVCodecParameters*   ffkmp_stream_codecpar(AVStream *s);
int64_t              ffkmp_stream_duration(AVStream *s);
int64_t              ffkmp_stream_duration_micros(AVStream *s);
int64_t              ffkmp_stream_start_time(AVStream *s);
int64_t              ffkmp_stream_nb_frames(AVStream *s);
AVDictionary*        ffkmp_stream_metadata(AVStream *s);
 ...
 */
void ffkmp_graph_free(AVFilterGraph **g);
...
/* Playback additions */
void ffkmp_codecctx_flush(AVCodecContext *c);
...
int ffkmp_avseek_flag_backward(void);
int ffkmp_avseek_flag_any(void);
int ffkmp_avseek_flag_byte(void);
int ffkmp_avseek_flag_frame(void);
int ffkmp_fmt_seek_file(AVFormatContext *ctx, int stream_index,
                                     int64_t min_ts, int64_t ts, int64_t max_ts, int flags);
int ffkmp_fmt_is_seekable(AVFormatContext *c);
void ffkmp_stream_discard_all(AVStream *s);
void ffkmp_stream_discard_none(AVStream *s);
int ffkmp_stream_disposition(AVStream *s);
int ffkmp_disposition_default(void);
int ffkmp_disposition_forced(void);
int ffkmp_disposition_hearing_impaired(void);
int ffkmp_disposition_visual_impaired(void);
int ffkmp_disposition_attached_pic(void);
...
int64_t ffkmp_packet_pos(AVPacket *p);
int ffkmp_frame_color_range(AVFrame *f);
int ffkmp_frame_colorspace(AVFrame *f);
int ffkmp_frame_color_primaries(AVFrame *f);
int ffkmp_frame_color_trc(AVFrame *f);
int ffkmp_frame_chroma_location(AVFrame *f);
